...
export const secondChapter: ChapterData = {
  ...
  scenes: [
...

    {
      ...
      actions: [
        {
          // id не должен совпадать с кнопкой в chapter2-night-city-6:
          // по этим идентификаторам пишется completedActions.
...
> AUTHORIZATION REQUIRED`,
...

    {
      ...
      content: {
        type: "text",
        text: "Кода ты, разумеется, не знаешь.",
      },
...

    {
      ...
      content: {
        type: "text",
        text: "Зато система хранит журнал.\n\nЧетыре чужие попытки войти.",
      },
...

    {
      ...
      content: {
        type: "text",
        text: "И под каждой — ответ системы.\n\nСколько цифр угадано и сколько из них стоит на своём месте.",
      },
...

    {
      ...
      content: {
        type: "text",
        text: "Наугад — тысячи вариантов.\n\nНо наугад и не нужно.",
      },
...
09:48  subject entered the workshop`,
...

    {
      ...
      // Только actions: одновременные actions и nextScene
      // дают неопределённое поведение.
      actions: [
        {
          id: "leave",
